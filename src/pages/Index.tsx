...
export default function Index() {
  const [contactKind, setContactKind] = useState<"orcamento" | "assistencia">(
    "orcamento"
  );
  ...
  const contact =
    contactKind === "assistencia"
      ? {
          ...
          headline: "Contato — Assistência Técnica",
          description:
  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        aria-label="Portfólio e sistemas">
        <div className="mx-auto max-w-6xl px-4">
          <Reveal>
      ...
      <section
        id="assistencia"
        className="scroll-mt-24 py-16"
        aria-label="Assistência Técnica">
        <div className="mx-auto max-w-6xl px-4">
          <Reveal>
                ...
                {contactKind === "assistencia" ? (
                  <div className="mt-6">
                    ...
                    <Link
                      ...
                      Ver página de Assistência Técnica
                      <ArrowRight className="h-4 w-4" />
                    </Link>
                  </div>
                ) : null}
